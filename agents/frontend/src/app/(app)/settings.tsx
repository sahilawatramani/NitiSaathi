...
export default function SettingsScreen() {
  ...
  const handleToggle = (key: keyof typeof consent) => {
    ...
    updateUserSettings({ consent: newState });
  };
  ...
  return (
    <AppLayout title="सेटिंग्स / Settings" hideHeader>
      {/* TopAppBar (similar to HTML) */}
      <View className="bg-white border-b border-surface-container-high h-16 px-6 w-full flex-row justify-between items-center z-10">
        <Text className="font-headline-sm text-headline-sm text-[#1A1A1A] font-semibold">
          सेटिंग्स / Settings
        </Text>
        <Pressable className="text-on-surface-variant hover:bg-surface-container-low rounded-full p-2 active:opacity-70 transition-opacity">
            ...
            <View className="flex-col">
              <View className="px-4 py-2 border-b border-surface-container-low bg-surface-bright">
                <ToggleRow 
                  ...
                  value={consent.transactionData}
                  onValueChange={() => handleToggle('transactionData')}
                />
              </View>
              ...
              <View className="px-4 py-2 border-b border-surface-container-low bg-background-off-white">
                <ToggleRow 
                  ...
                  value={consent.schemeEligibility}
                  onValueChange={() => handleToggle('schemeEligibility')}
                />
              </View>
              ...
              <View className="px-4 py-2 border-b border-surface-container-low bg-surface-bright">
                <ToggleRow 
                  ...
                  value={consent.fraudDetection}
                  onValueChange={() => handleToggle('fraudDetection')}
                />
              </View>
