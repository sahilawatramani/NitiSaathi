 ...
 * 100% pure single-language strings dynamically powered by useTranslation().
 */
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.avatarCard}>
          ...
          <Text style={styles.emailText}>{user?.email || 'rajesh.sharma@example.com'}</Text>
          {!profile.age && !editing && (
            <TouchableOpacity onPress={() => setEditing(true)} style={styles.setupHint}>
              <Text style={styles.setupHintText}>{t.profile.setupHint}</Text>
            </TouchableOpacity>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  editBtnText: { ...Typography.labelLg, color: Colors.primaryContainer, fontWeight: '700' },
  ...
  avatarLetter: { ...Typography.headlineLg, color: Colors.onPrimary, fontWeight: '800' },
  ...
  logoutText: { ...Typography.labelLg, color: Colors.error, fontWeight: '700' },
});
